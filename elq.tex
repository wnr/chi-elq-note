...
\section{Empirical evaluation}
  \subsection{Performance}
    ...
    % See figure~\ref{fig:erd-elq-scroll} for graphs that show how the \elq{} scroll-based solution performs compared to the other solutions.
    ...
    % The \elq{} solution also scales better, as more clearly shown in figure~\ref{fig:erd-solutions-regressed} that includes polynomial regression graphs for all three solutions.
    ...
    % The \elq{} scroll-based solution is preferred for Chrome, as the injection is 32-fold faster (when operating on 500 elements) than the object-based solution while the resize detection performance is the same for both solutions.
    ...
    %   \end{tabular}
    %   \caption{Performance of the object-based and \elq{} scroll-based solutions in different \glspl{layout engine} when operating on 100 elements.}
