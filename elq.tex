...
\section{Extensions via plugins}
  ...
  \subsection{Example Plugin Implementation}
    ...
    The applying plugin simply implements the \code{applyBreakpointStates} method to alter the \code{className} property of the element by the given element breakpoint states.
