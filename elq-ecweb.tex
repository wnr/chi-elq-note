...
% TODO: Write about px, em, rem somewhere in this section.
  ...
  \paragraph{The default breakpoints API.}
    ...
    Now that we have defined the breakpoints of the element, we can conditionally style it in CSS using the following classes:
    ...
    \paragraph{Nested modules.}
      ...
      The last style rule of the example given in the previous listing specifies that all paragraph elements should have white text if \emph{any} ancestor breakpoints element is wider than 500 pixels.
